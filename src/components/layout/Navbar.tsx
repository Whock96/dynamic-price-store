...
const Navbar: React.FC<NavbarProps> = ({ toggleSidebar }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200 transition-all duration-300 ease-in-out">
      <div className="h-16 mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8">
