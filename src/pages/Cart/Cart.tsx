...
const Cart = () => {
  ...
  }, [customerParam, productParam, customer, addItem, navigate, setCustomer, customers, setTransportCompanyId]);
                        ...
                        <div className="ml-6 p-3 border-l-2 border-ferplas-100 bg-gray-50 rounded-md">
                          ...
                          <div className="mt-4 pt-4 border-t border-gray-200">
                            ...
                            <Select 
                              ...
                              onValueChange={(value) => setTransportCompanyId(value || undefined)}
                            >
                            ...
                            <p className="text-xs text-gray-500 mt-1">
                              Selecione a transportadora que realizará a entrega
                            </p>
                          </div>
                        </div>
                      )}
